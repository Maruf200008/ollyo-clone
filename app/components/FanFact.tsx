...
const FanFact = () => {
  return (
    <div className=" my-32    ">
      <div className="">
        <h2
          className={`${roboto_slab.className} font-extrabold sm:text-center fun-fact_bg_title mt-[-290px] sm:mt-[-150px] md:mt-[-120px] lg:mt-[20px]  text-[40px]  sm:text-[80px] md:text-[90px] lg:text-[120px] xl:text-[160px] 2xl:text-[190px]      `}
        >
          OUR FUN FACTS
        </h2>
      </div>
